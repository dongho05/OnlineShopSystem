                            ...
                            <div class="block billing-details">
                                ...
                                <form class="checkout-form">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="full_name" value="${user.fullname}" name="fullname" placeholder="">
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="user_address" value="${user.address}" name="address" placeholder="">
                                    </div>
                                    <div class="checkout-country-code clearfix">
                                        <div class="form-group">
                                            <input type="text" class="form-control" id="user_post_code"  name="phone" value="${user.phone}">
                                        </div>
                                        <!--                                        <div class="form-group" >
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="user_country" value="${user.email}" name="email"placeholder="">
                                    </div>
                                </form>
