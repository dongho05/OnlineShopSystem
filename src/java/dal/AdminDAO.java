...
//    }
    public boolean sendEmail(User user, String code) {
        ...
        String toEmail = user.getEmail();
        String fromEmail = "hophuongdong25052001@gmail.com";
        String password = "vhydgyoqyqvfalbt";
    ...
    public void registerAccount(String fname, String uname, String email, String pass) {
        String sql = "insert [User](fullName,userName,userEmail,userPass,userRole) values (?,?,?,?,5)";
        try {
